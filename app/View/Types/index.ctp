<div class="types index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('facture'); ?></th>
			<th><?php echo $this->Paginator->sort('type_facture'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($type['Type']['facture']); ?>&nbsp;</td>
		<td><?php echo h($type['Type']['type_facture']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($type['Bill']['id'], array('controller' => 'bills', 'action' => 'view', $type['Bill']['id'])); ?>
		</td>
		<td class="actions">
